...
tf.app.flags.DEFINE_integer("from_vocab_size", 40000, "NormalWiki vocabulary size.")
tf.app.flags.DEFINE_integer("to_vocab_size", 40000, "SimpleWiki vocabulary size.")
tf.app.flags.DEFINE_string("data_dir", "/data/wtm/data/wikilarge/", "Data directory")
tf.app.flags.DEFINE_string("train_dir", "/data/wtm/data/wikilarge/model/translation/", "Training directory.")
