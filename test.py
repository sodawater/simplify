...
def add_arguments(parser):
    ...
    parser.add_argument("--nmt_ckpt_dir", type=str, default="/data/wtm/data/wikilarge/model/nmt/sgd_t4/",
...
def train_nmt(hparams, train=True, interact=False):
    ...
    loss_file1 = open("s4train_loss","a",encoding="utf-8")
    loss_file2 = open("s4eval_loss","a",encoding="utf-8")
    if train:
        while global_step < num_train_steps:
            ...
            if global_step % 50 == 0:
                ...
                loss_file1.write("\n")
                #print(loss / _source_buckets[bucket_id])
            if global_step % 5000 == 0 and global_step > 25000:
            ...
            if global_step % 2000 == 0:
                ...
                if ckpt and tf.train.checkpoint_exists(ckpt.model_checkpoint_path):
                    ...
                    outfile = open("test_out_sgd4_" + str(global_step), "w", encoding="utf-8")
                    for line in file:
        ...
        if ckpt and tf.train.checkpoint_exists(ckpt.model_checkpoint_path):
            ...
            if interact:
                ...
                while sentence:
                    ...
                    feed = {infer_model.model.encoder_input_ids: encoder_inputs,
                            infer_model.model.encoder_input_length: source_sequence_length}
                    sample_outputs, alignment, h = infer_sess.run([infer_model.model.sample_id,
                                                     infer_model.model.alignment_history,
                                                     infer_model.model.a],
                                                    feed_dict=feed)
                    print(alignment)
