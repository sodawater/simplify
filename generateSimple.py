...
def add_arguments(parser):
    ...
    parser.add_argument("--recon_ckpt_dir", type=str, default="/data/wtm/data/wikilarge/model/recon_0.5/",
...
_buckets = [(10, 5), (15, 10), (20, 15), (25, 20), (30, 25), (40, 35), (50, 45), (70, 70)]
#_buckets = [(80, 80)]
    ...
    if pretrain:
        while global_step < num_train_steps:
            ...
            if global_step % recon_hparams.steps_per_eval == 0:
                ...
                # print(loss)
                leng, _ = _buckets[bucket_id]
                print("step %d with eval loss %f" % (global_step, loss / leng))
    else:
        ckpt = tf.train.get_checkpoint_state(recon_hparams.recon_ckpt_dir)
        if ckpt and tf.train.checkpoint_exists(ckpt.model_checkpoint_path):
            infer_model.model.saver.restore(infer_sess, ckpt.model_checkpoint_path)
...
def main(_):
    ...
    train_recon(hparams, pretrain=True, train=False, interact=True)
